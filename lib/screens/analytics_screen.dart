  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [
          BoxShadow(color: Color.fromRGBO(200, 200, 200, 0.05), blurRadius: 15, offset: Offset(0, 5)),
        ],
      ),
      child: Column(
            ...
            child: PieChart(
              PieChartData(
                ...
                sections: widget.sortedCategories.asMap().entries.map((entry) {
                  ...
                  final percentage = (data.value / widget.totalSpending * 100);
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: widget.getCategoryColor(entry.key).withValues(alpha: 0.1),
                      borderRadius: BorderRadius.circular(10),
                    ),
                    child: Icon(widget.getCategoryIcon(entry.key), size: 18, color: widget.getCategoryColor(entry.key)),
                  ),
                        ...
                        Stack(
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: widget.getCategoryColor(entry.key),
                                borderRadius: BorderRadius.circular(2),
                              ),
                            ),
                          ],
...
class _AnalyticsScreenState extends State<AnalyticsScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _fetchData() async {
    ...
    try {
      ...
      _monthlyBudget = (userDoc.data() as Map<String, dynamic>?)?['monthlyBudget'] ?? 0.0;
      _monthlyBudget = _monthlyBudget.toDouble();

      double prevTotal = 0;
      if (prevSnapshot != null) {
        for (var doc in prevSnapshot.docs) {
          prevTotal += (doc.data() as Map<String, dynamic>)['amount'] as num? ?? 0.0;
        }
      }
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [AppColors.primaryNavy, Color.fromRGBO(25, 40, 65, 0.8)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(24),
        boxShadow: const [
          BoxShadow(color: Color.fromRGBO(25, 40, 65, 0.3), blurRadius: 15, offset: Offset(0, 8)),
        ],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
