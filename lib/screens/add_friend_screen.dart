...
class _AddFriendScreenState extends State<AddFriendScreen> {
  ...
  List<Map<String, String>> _suggestedContacts = [];
  ...
  Future<void> _syncPhoneContacts() async {
    ...
    try {
      final contactEmails = await ContactSyncService.getContactEmails();
      if (mounted) {
        setState(() => _suggestedContacts = contactEmails);
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Found ${contactEmails.length} contacts', style: AppTextStyles.bodyM),
            backgroundColor: AppColors.success,
          ),
        );
      }
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Error syncing contacts: $e', style: AppTextStyles.bodyM),
            backgroundColor: AppColors.error,
          ),
        );
      }
            ...
            children: [
                ...
                children: [
                  ...
                  ModernCard(
                    ...
                    child: IconButton(
                      ...
                      onPressed: _isSyncingContacts ? null : _syncPhoneContacts,
              ...
              if (_suggestedContacts.isNotEmpty) ...[
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: _suggestedContacts.take(5).map((contact) {
